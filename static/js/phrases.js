let dicasDeSenha = {
    ...
    "média": [
        "Sua senha está melhorando, mas ainda há espaço para aprimoramento.",
        "Adicione mais variedade à sua senha, como letras maiúsculas e minúsculas, números e símbolos.",
        "Evite sequências e repetições de caracteres, que podem ser adivinhadas mais facilmente.",
        "Não baseie sua senha em detalhes pessoais que possam ser conhecidos ou adivinhados por outros.",
        "Palavras comuns e nomes próprios são mais fáceis de adivinhar. Tente algo mais único.",
        "Evite usar informações que estejam relacionadas com você ou com o site para o qual a senha será usada.",
        "Considerar o uso de palavras de outro idioma pode dificultar a adivinhação da senha.",
        "Misture tipos de caracteres diferentes para tornar sua senha mais segura.",
        "A segurança pode ser melhorada substituindo letras por números ou símbolos.",
        "Evite usar a mesma senha em mais de um site. Isso pode torná-lo vulnerável se uma senha for descoberta."
    ],
    "boa": [
